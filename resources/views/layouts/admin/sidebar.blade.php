    ...
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                    <li><a class="nav-link" href="forms-advanced-form.html">Operator</a></li>
                    <li><a class="nav-link" href="forms-editor.html">Kasir</a></li>
                    <li><a class="nav-link" href="forms-validation.html">Siswa</a></li>
                </ul>
            </li>
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                    <li><a href="gmaps-advanced-route.html">Transaksi Baru</a></li>
                </ul>
            </li>
            <li class="nav-item dropdown">
