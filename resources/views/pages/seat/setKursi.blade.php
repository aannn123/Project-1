                            ...
                            <div class="row ml-1">
                                ...
                                <div class="mr-4 mt-3" style="">
                                    ...
                                    {{-- <div class="form-check form-check-inline">
                                      ...
                                      <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" value="Active" name="status" id="{{$item->id}}">
                                        <label class="form-check-label fas fa-check" style="color: green" ></label>
                                      </div>
                                      <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" value="Tidak" name="status" id="{{$item->id}}">
